package cn.elam.app.spider.NaviveBayesClassify;
...
import cn.elam.app.spider.NaviveBayesClassify.textSample.Topics;
...
//		String result = classifier.classify(text);// 进行分类
		String result = classifier.classify(Topics.SPORT_2_TOPIC);// 进行分类
		System.out.println("此项属于[" + resultMap.get(result) + "]");

	}

	static Map<String, String> resultMap = new HashMap<String, String>();
	static {
		resultMap.put("C000007", "汽车");
		resultMap.put("C000008", "财经");
		resultMap.put("C000010", "IT");
		resultMap.put("C000013", "健康");
		resultMap.put("C000014", "体育");
		resultMap.put("C000016", "旅游");
		resultMap.put("C000020", "教育");
		resultMap.put("C000022", "招聘");
		resultMap.put("C000023", "文化");
		resultMap.put("C000024", "军事");
	}
